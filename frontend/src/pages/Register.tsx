    ...
    <div className="flex flex-1 items-center justify-center p-4 relative z-10 animate-in-fade">
      <Card className="w-full max-w-sm glass border-white/50 shadow-2xl backdrop-blur-xl relative overflow-hidden">
        ...
        <CardHeader className="space-y-1 pb-6">
          <CardTitle className="text-3xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-br from-slate-800 to-slate-500">Create an account</CardTitle>
          <CardDescription className="text-slate-500">Build your AI-powered document brain.</CardDescription>
        </CardHeader>
